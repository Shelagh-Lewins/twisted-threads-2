// add tablets to a pattern or border section
...
const validate = (values, numberOfTablets, maxTablets) => {
  const errors = {};
  ...
  } else if (values.insertNTablets > maxTablets - numberOfTablets) {
    errors.insertNTablets = `Cannot exceed ${maxTablets - numberOfTablets}`;
  }
...
const AddTabletsForm = (props) => {
  const { maxTablets, numberOfTablets } = props;
  ...
  const formik = useFormik({
    ...
    validate: (values) => validate(values, numberOfTablets, maxTablets),
          ...
          <Col>
            <label htmlFor='insertNBorderTablets'>
              ...
              <input
                ...
                id='insertNTablets'
                max={maxTablets - numberOfTablets}
                min='1'
                name='insertNTablets'
                type='number'
