    ...
    >
      {({
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className='hint'>
            Create a set of colour swatches which can be assigned to any
            pattern&apos;s working palette.
          </p>
...
class AddColorBookForm extends Component {
  ...
  acceptColorChange = () => {
    const { colors, colorValue, selectedColorIndex } = this.state;
  ...
  renderEditColorPanel() {
    const { pickerReinitialize, colorValue } = this.state;
  ...
  render() {
    ...
    const { colors, pickerReinitialize, selectedColorIndex, colorValue } =
      this.state;
