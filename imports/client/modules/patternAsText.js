...
import { PATTERN_AS_TEXT_FIELDS } from '../../modules/parameters';

const beautify = require('js-beautify').js;

const getDisplayName = (fieldName) =>
  PATTERN_AS_TEXT_FIELDS.find((field) => fieldName === field.fieldName)
    .displayName;
...
const patternAsText = (_id, patternObj) => {
  ...
  if (leftBorder) {
    patternData[getDisplayName('leftBorder')] = leftBorder;
  }

  if (rightBorder) {
    patternData[getDisplayName('rightBorder')] = rightBorder;
  }
