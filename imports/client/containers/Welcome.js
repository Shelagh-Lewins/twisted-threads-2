        ...
        content = (
          <>
            ...
            <p>
              ...
              <strong>{userEmail}</strong>. Please click the link to verify your
              email address, or enter the verification code from the email in
              the box below. This will allow you to create more patterns and
              colour books.
            </p>
            <p>
            ...
            <p>
              ...
              request a new verification email on your{' '}
              <Link to='/account'>user account page</Link>.
            </p>
