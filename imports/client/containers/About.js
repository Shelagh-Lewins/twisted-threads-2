				...
				<Container>
					...
					<Row>
						<Col>
							...
							<ul>
								<li>Individual: design your pattern by clicking the chart to set the turning direction and number of turns for each tablet.</li>
							...
							<p>Twisted Threads patterns use the notation developed in the excellent book <a href="https://www.salakirjat.com/product/159/applesies-and-fox-noses---finnish-tabletwoven-bands" target="_blank" rel="noreferrer noopener">Applesies and Fox Noses - Finnish Tablewoven Bands</a>.</p>
							<h2>Development</h2>
