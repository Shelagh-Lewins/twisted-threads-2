	...
	renderOrientations() {
		...
		return (
			<div className="orientations">
				...
				<p className="hint">The sloping line below each tablet shows you how to orient that tablet. The slope of the tablet when viewed from above should match the slope of the line.</p>
			</div>
		);
	}
