...
function DonatePatreon() {
	return (
		<div className="donate-patreon" title="Support Twisted Threads on Patreon">
			...
			<a href="https://www.patreon.com/bePatron?u=31384826" data-patreon-widget-type="become-patron-button">Become a Patron!</a><script async src="https://c6.patreon.com/becomePatronButton.bundle.js" />
		</div>
	);
}
