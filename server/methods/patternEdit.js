  ...
  'pattern.edit': async function ({ _id, data }) {
    ...
    if (!Meteor.userId()) {
      throw new Meteor.Error(
        ...
        'Unable to edit pattern because the user is not logged in',
      );
    }
    ...
    if (!pattern) {
      throw new Meteor.Error(
        ...
        'Unable to edit pattern because the pattern was not found',
      );
    }
    ...
    if (pattern.createdBy !== Meteor.userId()) {
      throw new Meteor.Error(
        ...
        'Unable to edit pattern because pattern was not created by the current logged in user',
      );
    }
    ...
    switch (type) {
      case 'editIsPublic':
        ...
        if (!(await Roles.userIsInRoleAsync(Meteor.userId(), 'verified'))) {
          throw new Meteor.Error(
            'edit-pattern-not-verified',
            "Unable to make the pattern public or private because the user's email address is not verified",
          );
        }
      ...
      case 'editWeavingCellDirection':
        ...
        switch (patternType) {
          ...
          default:
            throw new Meteor.Error(
              'edit-weaving-cell-direction-unknown-pattern-type',
              `Unable to add weaving cell direction because the pattern type ${patternType} was not recognised`,
            );
        }
        ...
        switch (patternType) {
          case 'individual':
            return Patterns.updateAsync(
              ...
              {
                $set: {
                  [`patternDesign.weavingInstructions.${row}.${tablet}.numberOfTurns`]:
                    numberOfTurns,
                },
              },
            );
          ...
          default:
            throw new Meteor.Error(
              'edit-weaving-cell-turns-unknown-pattern-type',
              `Unable to edit weaving cell turns because the pattern type ${patternType} was not recognised`,
            );
        }
        ...
        switch (patternType) {
          case 'allTogether':
            ...
            return Patterns.updateAsync(
              ...
              {
                $set: {
                  [`patternDesign.weavingInstructions.${row}`]: newDirection,
                },
              },
            );
          ...
          default:
            throw new Meteor.Error(
              'edit-weaving-row-direction-unknown-pattern-type',
              `Unable to edit weaving is not allTogether`,
            );
        }
        ...
        switch (patternType) {
          case 'doubleFaced':
            ...
            if (rowIndex > chartLength - 1) {
              throw new Meteor.Error(
                'edit-double-faced-pattern-chart-invalid-rowIndex',
                `Unable to edit double faced pattern chart because the rowIndex was greater than the number of chart rows`,
              );
            }
            ...
            return Patterns.updateAsync(
              ...
              {
                $set: {
                  [`patternDesign.doubleFacedPatternChart.${rowIndex}.${tabletIndex}`]:
                    newValue,
                },
              },
            );
          ...
          default:
            throw new Meteor.Error(
              'edit-double-faced-chart-unknown-pattern-type',
              `Unable to edit double faced pattern chart because the pattern type ${patternType} is not doubleFaced`,
            );
        }
      ...
      case 'editTwillChart':
        ...
        switch (patternType) {
          case 'brokenTwill':
            ...
            if (rowIndex > chartLength - 1) {
              throw new Meteor.Error(
                'edit-twill-pattern-chart-invalid-rowIndex',
                `Unable to edit twill pattern chart because the rowIndex was greater than the number of chart rows`,
              );
            }

            if (tabletIndex % 2 === 1 && rowIndex === 0) {
              throw new Meteor.Error(
                'edit-twill-pattern-chart-invalid-chart-cell',
                `Unable to edit twill pattern chart because the first row of an even tablet cannot be edited`,
              );
            }
            ...
            return Patterns.updateAsync(
              ...
              {
                $set: {
                  [`patternDesign.${twillChart}.${rowIndex}.${tabletIndex}`]:
                    newValue,
                },
              },
            );
          ...
          default:
            throw new Meteor.Error(
              'edit-twill-pattern-chart-unknown-pattern-type',
              `Unable to edit twill pattern chart because the pattern type ${patternType} is not brokenTwill`,
            );
        }
        ...
        switch (patternType) {
          case 'brokenTwill':
            if (weavingStartRow >= numberOfRows) {
              throw new Meteor.Error(
                'edit-twill-weaving-start-row-invalid-rowIndex',
                `Unable to edit twill pattern chart because the weaving start row must be less than the number of rows`,
              );
            }
            ...
            if (weavingStartRow % 2 !== 1) {
              throw new Meteor.Error(
                'edit-twill-weaving-start-row-invalid-rowIndex',
                `Unable to edit twill pattern chart because the weaving start row must be an odd number`,
              );
            }
          ...
          default:
            throw new Meteor.Error(
              'edit-twill-weaving-start-row-unknown-pattern-type',
              `Unable to edit twill weaving start row because the pattern type ${patternType} is not brokenTwill`,
            );
        }
        ...
        switch (patternType) {
          case 'freehand':
            return Patterns.updateAsync(
              ...
              {
                $set: {
                  [`patternDesign.freehandChart.${row}.${tablet}.threadColor`]:
                    threadColor,
                  [`patternDesign.freehandChart.${row}.${tablet}.threadShape`]:
                    threadShape,
                },
              },
            );
          ...
          default:
            throw new Meteor.Error(
              'edit-freehand-cell-thread-unknown-pattern-type',
              `Unable to edit freehand cell thread because the pattern type ${patternType} is not freehand`,
            );
        }
        ...
        switch (patternType) {
          case 'freehand':
            ...
            return Patterns.updateAsync(
              ...
              {
                $set: {
                  [`patternDesign.freehandChart.${row}.${tablet}.direction`]:
                    direction,
                },
              },
            );
          ...
          default:
            throw new Meteor.Error(
              'edit-freehand-cell-direction-unknown-pattern-type',
              `Unable to edit freehand cell direction because the pattern type ${patternType} is not freehand`,
            );
        }
      ...
      case 'addWeavingRows':
        ...
        if (insertNRows + numberOfRows > MAX_ROWS) {
          throw new Meteor.Error(
            'add-rows-too-many-rows',
            'Unable to add rows because the pattern will have too many rows',
          );
        }

        if (insertRowsAt < 0 || insertRowsAt > numberOfRows) {
          throw new Meteor.Error(
            'add-rows-invalid position',
            'Unable to add rows because the position is invalid',
          );
        }
        ...
        switch (patternType) {
          ...
          case 'doubleFaced':
            if (insertNRows % 2 !== 0) {
              throw new Meteor.Error(
                'add-rows-invalid-number',
                'Unable to add rows because the number of rows must be even for double faced',
              );
            }
            ...
            if (insertRowsAt % 2 !== 0) {
              throw new Meteor.Error(
                'add-rows-invalid-number',
                'Unable to add rows because the new rows must be inserted at an odd row for double faced',
              );
            }
          ...
          case 'brokenTwill':
            if (insertNRows % 2 !== 0) {
              throw new Meteor.Error(
                'add-rows-invalid-number',
                'Unable to add rows because the number of rows must be even for broken twill',
              );
            }
            ...
            if (insertRowsAt % 2 !== 0) {
              throw new Meteor.Error(
                'add-rows-invalid-number',
                'Unable to add rows because the new rows must be inserted at an odd row for broken twill',
              );
            }
          ...
          default:
            throw new Meteor.Error(
              'add-rows-unknown-pattern-type',
              `Unable to add rows because the pattern type ${patternType} was not recognised`,
            );
        }
      ...
      case 'removeWeavingRows':
        ...
        if (pattern.numberOfRows <= removeNRows) {
          throw new Meteor.Error(
            'remove-rows-last-row',
            'Unable to remove rows because the last row would be removed',
          );
        }

        if (pattern.numberOfRows < removeRowsAt) {
          throw new Meteor.Error(
            'remove-rows-invalid-row',
            'Unable to remove row because the row does not exist',
          );
        }
        ...
        switch (patternType) {
          case 'individual':
            ...
            for (let i = 0; i < removeNRows; i += 1) {
              ...
              await Patterns.updateAsync(
                ...
                {
                  $set: {
                    [`patternDesign.weavingInstructions.${rowIndex}.${0}.toBeRemoved`]: true,
                  },
                },
              );
            }
          ...
          case 'allTogether':
            ...
            for (let i = 0; i < removeNRows; i += 1) {
              ...
              await Patterns.updateAsync(
                ...
                {
                  $set: {
                    [`patternDesign.weavingInstructions.${rowIndex}`]:
                      'toBeRemoved',
                  },
                },
              );
            ...
            update.$pull = {
              'patternDesign.weavingInstructions': 'toBeRemoved',
            };
          ...
          case 'doubleFaced':
            if (removeNRows % 2 !== 0) {
              throw new Meteor.Error(
                'remove-rows-invalid-number',
                'Unable to remove rows because the number of rows must be even for double faced',
              );
            }
            ...
            if (removeRowsAt % 2 !== 0) {
              throw new Meteor.Error(
                'add-rows-invalid-number',
                'Unable to remove rows because the rows must be removed at an even row for double faced',
              );
            }
            ...
            for (let i = 0; i < removeNRows / 2; i += 1) {
              ...
              await Patterns.updateAsync(
                ...
                {
                  $set: {
                    [`patternDesign.doubleFacedPatternChart.${rowIndex}`]:
                      'toBeRemoved',
                  },
                },
              );
          ...
          case 'brokenTwill':
            if (removeNRows % 2 !== 0) {
              throw new Meteor.Error(
                'remove-rows-invalid-number',
                'Unable to remove rows because the number of rows must be even for broken twill',
              );
            }
            ...
            if (removeRowsAt % 2 !== 0) {
              throw new Meteor.Error(
                'add-rows-invalid-number',
                'Unable to remove rows because the rows must be removed at an even row for broken twill',
              );
            }
            ...
            for (let i = 0; i < removeNRows / 2; i += 1) {
              ...
              await Patterns.updateAsync(
                ...
                {
                  $set: {
                    [`patternDesign.twillDirectionChangeChart.${rowIndex}`]:
                      'toBeRemoved',
                    [`patternDesign.twillPatternChart.${rowIndex}`]:
                      'toBeRemoved',
                  },
                },
              );
            ...
            for (let i = 1; i < numberOfTablets; i += 2) {
              if (
                pattern.patternDesign.twillDirectionChangeChart[newFirstRow][
                  i
                ] === 'X'
              ) {
                await Patterns.updateAsync(
          ...
          case 'freehand':
            for (let i = 0; i < removeNRows; i += 1) {
              ...
              await Patterns.updateAsync(
                ...
                {
                  $set: {
                    [`patternDesign.freehandChart.${rowIndex}.${0}.toBeRemoved`]: true,
                  },
                },
              );
            }
      ...
      case 'addTablets':
        ...
        try {
          ...
          throw new Meteor.Error(
            'edit-pattern-add-tablets-check-failed',
            `Unable to add tablets for pattern ${_id} because check insertNTablets failed with error ${err.message}`,
          );
        }
        ...
        try {
          ...
          throw new Meteor.Error(
            'edit-pattern-add-tablets-check-failed',
            `Unable to add tablets for pattern ${_id} because check insertTabletsAt failed with error ${err.message}`,
          );
        }
        ...
        try {
          ...
          throw new Meteor.Error(
            'edit-pattern-add-tablets-check-failed',
            `Unable to add tablets for pattern ${_id} because check colorIndex failed with error ${err.message}`,
          );
        }

        update.$push = {};

        if (getTotalPatternTablets(pattern) + insertNTablets > MAX_TABLETS) {
          throw new Meteor.Error(
            'add-tablets-too-many-rows',
            'Unable to add tablets because the pattern will have too many tablets',
          );
        }

        if (insertTabletsAt < 0 || insertTabletsAt > numberOfTablets) {
          throw new Meteor.Error(
            'add-tablets-invalid position',
            'Unable to add tablets because the position is invalid',
          );
        }
        ...
        if (patternType !== 'freehand') {
          const newIncludeInTwist = new Array(insertNTablets);
          newIncludeInTwist.fill(true);
        ...
        // insert new tabletGuides
        const newTabletGuides = new Array(insertNTablets);
        newTabletGuides.fill(false);

        update.$push.tabletGuides = {
          $each: newTabletGuides,
          $position: insertTabletsAt,
        };
        ...
        switch (patternType) {
          ...
          case 'doubleFaced':
            ...
            for (let i = 0; i < holes; i += 1) {
              ...
              for (
                let j = insertTabletsAt;
                j < insertTabletsAt + insertNTablets;
                j += 1
              ) {
                const colorRole = DOUBLE_FACED_THREADING[i];

                newDoubleFacedThreading[i].splice(
                  j,
                  0,
                  colorRole === 'F'
                    ? DOUBLE_FACED_FOREGROUND
          ...
          case 'brokenTwill':
            ...
            for (let i = 0; i < holes; i += 1) {
              for (let j = 0; j < colorsForRolesByTablet.length; j += 1) {
                ...
                const colorRole =
                  BROKEN_TWILL_THREADING[i][changedTabletIndex % holes];
      ...
      case 'removeTablet':
        ...
        if (numberOfTablets === 1) {
          throw new Meteor.Error(
            'edit-pattern-remove-tablet-last-tablet',
            'Unable to remove tablet because there is only one tablet',
          );
        }
        ...
        const orientationToRemove =
          patternType === 'doubleFaced' ? numberOfTablets - 1 : tablet;
        update.$set = {
          [`orientations.${orientationToRemove}`]: 'toBeRemoved',
        };
        // !warning! don't overwrite the update object

        // each tablet's includeInTwist is independent
        if (patternType !== 'freehand') {
        ...
        switch (patternType) {
          ...
          case 'freehand':
            ...
            if (patternType === 'individual') {
              update.$set[
                `patternDesign.weavingInstructions.$[].${tablet}.toBeRemoved`
              ] = true;
            }

            if (patternType === 'freehand') {
              update.$set[`patternDesign.freehandChart.$[].${tablet}`] =
                'toBeRemoved';
            }
            break;
          ...
          case 'doubleFaced':
            ...
            // remove the specified tablet
            update.$set[`patternDesign.doubleFacedPatternChart.$[].${tablet}`] =
              'toBeRemoved';
            break;

          case 'brokenTwill':
            update.$set[
              `patternDesign.twillDirectionChangeChart.$[].${tablet}`
            ] = 'toBeRemoved';
            update.$set[`patternDesign.twillPatternChart.$[].${tablet}`] =
              'toBeRemoved';
            break;

          default:
            throw new Meteor.Error(
              'remove-tablet-unknown-pattern-type',
              `Unable to remove tablet because the pattern type ${patternType} was not recognised`,
            );
        }
        ...
        switch (patternType) {
          case 'individual':
            ...
            update2.$pull['patternDesign.weavingInstructions.$[]'] = {
              toBeRemoved: true,
            };
            break;
          ...
          case 'doubleFaced':
            ...
            update2.$pull['patternDesign.doubleFacedPatternChart.$[]'] =
              'toBeRemoved';
            break;
          ...
          case 'brokenTwill':
            ...
            update2.$pull['patternDesign.twillDirectionChangeChart.$[]'] =
              'toBeRemoved';
            update2.$pull['patternDesign.twillPatternChart.$[]'] =
              'toBeRemoved';
            break;
      ...
      case 'paletteColor':
        ...
        try {
          ...
          throw new Meteor.Error(
            'edit-pattern-palette-color-check-failed',
            `Unable to edit palette for pattern ${_id} because check colorHexValue failed with error ${err.message}`,
          );
        }
        ...
        try {
          ...
          throw new Meteor.Error(
            'edit-pattern-palette-color-check-failed',
            `Unable to edit palette for pattern ${_id} because check colorIndex failed with error ${err.message}`,
          );
        }

        if (!tinycolor(colorHexValue).isValid()) {
          throw new Meteor.Error(
            'edit-pattern-palette-color-invalid',
            'Unable to edit pattern because the new palette color is not a valid color',
          );
        }
        // update the value in the nested arrays
        return Patterns.updateAsync(
      ...
      case 'holeHandedness':
        if (patternType !== 'freehand') {
          throw new Meteor.Error(
            'edit-pattern-holehandedness',
            'Unable to edit holehandedness because the pattern is not of type freehand',
          );
        }
      ...
      case 'weftColor':
        ...
        if (colorIndex === -1) {
          throw new Meteor.Error(
            'edit-weft-no-empty',
            'Unable to edit pattern because empty hole was specified as weft color',
          );
        }
      ...
      case 'includeInTwist':
        ...
        if (tablet >= numberOfTablets) {
          throw new Meteor.Error(
            'edit-include-in-twist-invalid-tablet',
            'Unable to edit include in twist because an invalid tablet number was specified',
            tablet,
          );
        }
      ...
      case 'tabletGuides':
        ({ tablet, tabletGuide } = data);
        check(tablet, validTabletsCheck);

        if (tablet >= numberOfTablets) {
          throw new Meteor.Error(
            'edit-tablet-guides-invalid-tablet',
            'Unable to edit tablet guides ation because an invalid tablet number was specified, tablet',
          );
        }
      ...
      case 'orientation':
        ...
        if (patternType === 'doubleFaced') {
          throw new Meteor.Error(
            'edit-orientation-broken-twill',
            'Unable to edit orientation because the pattern type is double faced',
          );
        }
        ...
        if (patternType === 'brokenTwill') {
          throw new Meteor.Error(
            'edit-orientation-broken-twill',
            'Unable to edit orientation because the pattern type is broken twill',
          );
        }

        if (tablet >= numberOfTablets) {
          throw new Meteor.Error(
            'edit-orientation-invalid-tablet',
            'Unable to edit orientation because an invalid tablet number was specified',
          );
        }
      ...
      case 'previewOrientation':
        ...
        const values = ALLOWED_PREVIEW_ORIENTATIONS.map(
          (option) => option.value,
        );

        if (values.indexOf(orientation) === -1) {
          throw new Meteor.Error(
            'edit-pattern-preview-orientation-invalid',
            'Unable to edit pattern because an invalid preview orientation was specified',
          );
        }
      ...
      // /////////////////////
      // Border tablet operations (doubleFaced and brokenTwill patterns only)
      // A border is created implicitly when the first tablet is added (numberOfTablets goes from 0 to N).
      // It is removed implicitly when the last tablet is removed (numberOfTablets reaches 0).
      ...
      case 'addRightBorderTablets': {
        ...
        if (!['doubleFaced', 'brokenTwill'].includes(patternType)) {
          throw new Meteor.Error(
            'add-border-tablets-invalid-pattern-type',
            `Unable to add border tablets because the pattern type ${patternType} does not support borders`,
          );
        }
        ...
        if (existingBorder && existingBorder.numberOfTablets > 0) {
          ...
          const existingTablets = existingBorder.numberOfTablets;
          const newBorderTablets = existingTablets + insertNTablets;
      ...
      case 'removeRightBorderTablet': {
        ...
        if (!existingBorder || existingBorder.numberOfTablets === 0) {
          throw new Meteor.Error(
            'remove-border-tablet-no-border',
            `Unable to remove border tablet because the ${borderKey} does not exist`,
          );
        }

        const newBorderTablets = existingBorder.numberOfTablets - 1;

        if (newBorderTablets === 0) {
          // Remove the entire border
          return Patterns.updateAsync({ _id }, { $unset: { [borderKey]: '' } });
        }
      ...
      case 'editBorderThreadingCell': {
        // side: 'left' | 'right', holesToSet: number[], tablet: number, colorIndex: number
        let side;
        ...
        holesToSet.forEach((holeIndex) => {
          setObj[`${borderKey}.threading.${holeIndex}.${tablet}`] = colorIndex;
        });

        return Patterns.updateAsync({ _id }, { $set: setObj });
      }

      case 'editBorderOrientation': {
        let side;
      ...
      case 'editBorderWeavingCell': {
        // Toggle direction for this row and all following rows (same as Individual pattern logic)
        let side;
      ...
      default:
        throw new Meteor.Error(
          ...
          'Unable to edit pattern because the type was unknown',
        );
    }
  },
});
